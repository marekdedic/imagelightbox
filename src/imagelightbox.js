...
;(function ($, window, document, undefined) {
  ...
  $.fn.imageLightbox = (function (opts) {
    var options = $.extend({
      ...
      //
      //
      navTargetDefault: function (navTarget) {
        //
      ...
      nextTargetDefault: function () {
        ...
        window.history.pushState(null,'',window.location+'/loool');
        target = targets.eq(targetIndex);
        loadImage('right');
        return targetIndex;
      }
    ...
    var loadNextImage = function () {
      //
      if (options.nextTargetDefault() !== false) {
        loadImage('right');
      }
    };
    var loadPreviousImage = function () {
      ...
      if (options.previousTargetDefault() !== false) {
        loadImage('left');
      }
    };
    var loadNavImage = function (navIndex) {
      ...
      if (options.navTargetDefault(navIndex) !== false) {
        loadImage('right');
      }
    };
    ///
    ...
    var loadImage = function (direction) {
      ...
      //   console.log("LOAD IMAGE IS CALLED WITH "+targetIndex);
      if (inProgress) {
        return false;
      }
      //      
